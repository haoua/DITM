	...
	<div class="bg-white p-3 rounded shadow mb-5">
        ...
        <fieldset>
            <dl>
                ...
                <div class="flex">
                    <div class="w-1/2"><label for="text"><input id="text" type="radio" name="search_by" value="text" checked="checked" /> {switch_search_full_text.L_SEARCH_BY_TEXT}</label></div>
                    <div class="w-1/2"><label for="subject"><input id="subject" type="radio" name="search_by" value="subject" /> {switch_search_full_text.L_SEARCH_BY_SUBJECT}</label></div>
                </div>
                <br/>
    ...
    <div class="row3">
        <div class="inner">
            <fieldset class="submit-buttons">
                ...
                <input class="button1 bg-gradient text-white text-center w-full rounded shadow py-3 uppercase" type="submit" value="{L_SEARCH}" onclick="document.searchform.google.value='';" />
            </fieldset>
