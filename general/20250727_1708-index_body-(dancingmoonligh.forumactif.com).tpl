...
<div class="bg-zinc-200 dark:bg-zinc-700 shadow my-3 p-2 rounded flex gap-2">
	<div class="flex-1">
		<div class="flex gap-2">
			<div class="w-3/4">
				<div class="shadow">
					<div class="bg-white flex-1 rounded-t p-2 text-justify overflow-auto h-24" id="qeel__online_users_list" >
						{LOGGED_IN_USER_LIST}
					</div>
				...
				<div class="flex mt-3">
					<div class="flex items-center mr-3 uppercase font-sm bg-white p-1 shadow rounded hidden">
					...
					<div class="flex items-center mr-3 uppercase font-sm bg-white p-1 shadow rounded">
					...
					<div class="flex items-center uppercase font-sm bg-white p-1 shadow rounded flex-1">
						<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="hidden bi bi-cake2 mr-1" viewBox="0 0 16 16">
			...
			<div id="DITM_last_connected" class="w-1/4 flex flex-col">
				<div class="bg-gradient flex rounded-t py-2 px-1">
					<div class="bg-white rounded py-1 px-4 font-bold uppercase font-roboto mx-auto">
						<span id="qeel_nb-active-users" class="text-gradient"></span>
					</div>
				</div>
				<div class="rounded-b bg-white shadow p-2 grow">
					{L_CONNECTED_MEMBERS}
				</div>
			</div>
		</div>
...
<script type="text/javascript">
	...
	*/
	...
	$("#qeel__online_users_stats").parent().append('<div class="bg-white rounded py-1 px-4 font-bold uppercase font-roboto">'+
