		...
		<div class="flex gap-2 mt-3">
			...
			<div class="w-1/2 flex flex-col gap-2">
				<div class="flex gap-2 h-1/2">
					<div class="flex-1 rounded shadow hover:text-white text-center bg-white dark:bg-zinc-900 dark:hover:bg-blue-500 hover:bg-orange-500 text-orange-500 duration-700 ease-in-out flex items-center justify-center">Born of the Sun</div>
