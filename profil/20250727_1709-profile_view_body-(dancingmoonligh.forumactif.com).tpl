...
<br/>
<div class="rounded bg-white rounded p-4" id="wombat">
	<!-- Username -->
	<div class="flex items-center gap-2">
		<div class="page-title rounded p-1 text-center shadow flex-1" style="background: var(--transparent)">
		...
		<div id="image_profile" class="hidden bg-cover bg-center bg-no-repeat rounded" style="width: 64px;height: 64px;">
		</div>
		<div class="profile_link_tooltip_trigger relative">
			<a href="https://dancinginthemoon.forumactif.com/privmsg?mode=post&u={CUR_USER_ID}" class="rounded shadow text-center block profile_btn text-center bg-gradient text-white" style="padding:21px;">
		...
		<div class="profile_link_tooltip_trigger relative">
			<a href="https://dancinginthemoon.forumactif.com/st/u{CUR_USER_ID}" class="rounded shadow text-center block profile_btn text-center bg-gradient text-white" style="padding: 18px 21px;">
		...
		<div class="profile_link_tooltip_trigger relative">
			<a href="https://dancinginthemoon.forumactif.com/sta/u{CUR_USER_ID}" class="rounded shadow text-center block profile_btn text-center bg-gradient text-white" style="padding: 18px 21px;">
		...
		<div class="profile_link_tooltip_trigger relative">
			<a href="https://dancinginthemoon.forumactif.com/spa/u{CUR_USER_ID}" class="rounded shadow text-center block profile_btn text-center bg-gradient text-white" style="padding: 18px 21px;">
	...
	<div class="flex py-4 gap-4">
		...
		<div>
			...
			<div class="relative profile_avatar p-2 shadow rounded bg-white" id="user_avatar">
				...
				<div class="absolute bg-green-400 h-4 w-4 rounded-full border-2" style="bottom: 5px;right: 5px; border-color:var(--transparent);"></div>
...
<script type="text/javascript">
	...
	let img = $("#field_id1 img").attr("src");
	if(img !== undefined){
		$("#image_profile").css("background-image", "url("+img+")");
		$('#image_profile').css("display", "initial");
	}
	$("#field_id1").css("display", "none");
